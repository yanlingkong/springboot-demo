...
import com.example.demo.common.constant.MsgConstant;
...
public class CommonUtils {
     ...
     * @return
     */
    public static ResponseEntity msg(int count) {
        if(isIntThanZero(count)){
            return ResponseEntity.ok(MsgConstant.MSG_OPERATION_SUCCESS);
        }
        return ResponseEntity.error(MsgConstant.MSG_OPERATION_FAILED);
    }
     ...
     * @return
     */
    public static ResponseEntity msg(Object data) {
        if(isNullOrEmpty(data)){
            return ResponseEntity.error(MsgConstant.MSG_INIT_FORM);
        }
        return ResponseEntity.ok().put(MsgConstant.DATA_ROWS, data);
    }
     ...
     * @return
     */
    public static ResponseEntity msgNotCheckNull(Object data) {
        return ResponseEntity.ok().put(MsgConstant.DATA_ROWS, data);
    }
     ...
     * @return
     */
    public static ResponseEntity msg(Object[] total, int count) {
        if(total.length == count){
            return ResponseEntity.ok(MsgConstant.MSG_OPERATION_SUCCESS);
        }else{
            if(isIntThanZero(count)){
                return ResponseEntity.error(MsgConstant.removeFailed(total.length, count));
            }else{
                return ResponseEntity.error(MsgConstant.MSG_OPERATION_FAILED);
            }
        }
